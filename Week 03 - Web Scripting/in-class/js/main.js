...
function expandCells(row, col) {
    /*
    This function uses the Breadth-First Search (BFS) algorithm to explore all cells around
    ...
    */
    ...
    while (frontier.length > 0) { // While there is stuff to explore...
        ...
        if (number === 0) {
            ...
            frontier.push(...neighbours); // FIXME: We should filter contents by visited here!
        }
